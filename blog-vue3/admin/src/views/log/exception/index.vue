  ...
  <div class="app-container">
    ...
    <el-form :model="logQuery" :inline="true" v-show="showSearch">
      <el-form-item label="异常模块">
        <el-input
          @keyup.enter="queryExceptionLogs"
          v-model="logQuery.optModule"
          style="width: 200px"
          placeholder="请输入异常模块"
          clearable
        />
      ...
      <el-form-item>
        <el-button type="primary" icon="Search" @click="queryExceptionLogs"
          >搜索</el-button
        >
      </el-form-item>
    </el-form>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Delete"
          @click="deleteExceptionLogs(undefined)"
          >批量删除
        </el-button>
      </el-col>
      <right-toolbar
        v-model:showSearch="showSearch"
        @queryTable="getExceptionLogLists"
      ></right-toolbar>
    </el-row>
    <!-- 表格展示 -->
    <el-table
      ...
      <el-table-column label="操作" align="center" width="150">
        <template #default="scope">
          ...
          <el-button
            ...
            icon="Delete"
            link
            @click="deleteExceptionLogs(scope.row.id)"
          >
            删除
          </el-button>
        </template>
    ...
    <pagination
      ...
      @pagination="getExceptionLogLists"
    />
    <!-- 操作日志详细 -->
...
<script setup>
import { getExceptionLogList, deleteException } from "@/api/log";
...
const deleteExceptionLogs = (id) => {
  ...
  modal
    ...
    .then(() => {
      deleteException(ids).then(() => {
        modal.notifySuccess("删除成功");
        getExceptionLogLists();
      });
    })
    .catch(() => {});
};

const getExceptionLogLists = () => {
  loading.value = true;
  getExceptionLogList(logQuery.value).then(({ data }) => {
