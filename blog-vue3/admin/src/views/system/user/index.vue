...
<template>
  <div class="app-container">
    ...
    <el-form :model="userQuery" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="Search" @click="queryUser"
          >搜索</el-button
        >
      </el-form-item>
    </el-form>
    ...
    <pagination
      v-if="count > 0"
      :total="count"
      v-model:page="userQuery.current"
...
const openModel = (user) => {
  ...
  userFormRef.value ? userFormRef.value.clearValidate() : undefined;
  update.value = true;
};
...
const getUserLists = () => {
  loading.value = true;
  getUserList(userQuery.value).then(({ data }) => {
