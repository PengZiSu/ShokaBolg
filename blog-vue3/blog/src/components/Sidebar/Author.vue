      ...
      <template #data>
        <div class="author-info">
          <n-avatar
            ...
            round
            :size="150"
            :src="blogStore.siteConfig.authorAvatar"
          />
        ...
        <div class="social-info">
          <n-popover
            trigger="hover"
            placement="bottom"
            v-if="showSocial('github')"
          >
            <template #trigger>
              <a
                target="_blank"
                :href="blogStore.siteConfig.github"
                class="social-item"
              >
          ...
          <n-popover
            trigger="hover"
            placement="bottom"
            v-if="showSocial('gitee')"
          >
            <template #trigger>
              <a
                target="_blank"
                :href="blogStore.siteConfig.gitee"
                class="social-item"
              >
          ...
          <n-popover
            trigger="hover"
            placement="bottom"
            v-if="showSocial('bilibili')"
          >
            <template #trigger>
              <a
                target="_blank"
                :href="blogStore.siteConfig.bilibili"
                class="social-item"
              >
...
const showSocial = computed(
  () => (social) => blogStore.siteConfig.socialList.includes(social)
);
